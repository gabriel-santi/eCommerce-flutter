...
class AddToCartWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ref.listen(addToCartControllerProvider, (_, state) => state.showAlertDialogOnError(context));
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            ...
            ItemQuantitySelector(
              ...
              onChanged:
                  state.isLoading ? null : (quantity) => ref.read(addToCartControllerProvider.notifier).updateQuantity(quantity),
            ),
          ],
        ),
        gapH8,
        ...
        PrimaryButton(
          ...
          onPressed: availableQuantity > 0 ? () => ref.read(addToCartControllerProvider.notifier).addToCart(product.id) : null,
